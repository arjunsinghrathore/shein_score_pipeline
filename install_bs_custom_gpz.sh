...
git clone "${git_path}arjunsinghrathore/brain-score.git"
cd brain-score
git checkout hackaton
pip install -e .
cd ..
git clone  "${git_path}arjunsinghrathore/result_caching.git"
cd result_caching
git checkout hackaton
pip install -e .
cd ..
git clone "${git_path}arjunsinghrathore/model-tools.git"
cd model-tools
git checkout hackaton
pip install -e .
cd ..
git clone "${git_path}arjunsinghrathore/brainio_contrib.git"
cd brainio_contrib
git checkout hackaton
pip install -e .
cd ..
git clone  "${git_path}arjunsinghrathore/brainio_collection.git"
cd brainio_collection
git checkout hackaton
pip install -e .
cd ..
git clone "${git_path}arjunsinghrathore/brainio_base.git"
cd brainio_base
git checkout hackaton
pip install -e .
cd ..
git clone "${git_path}arjunsinghrathore/candidate_models.git"
cd candidate_models
git checkout hackaton
pip install -e .
cd ..
